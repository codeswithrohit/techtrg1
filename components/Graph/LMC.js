...
const LMC = ({ maincoursestudents, selectedCourse, selectedYears,selectedMainCourse }) => {
    ...
    const handleDoughnutClick = (event, elements) => {
        ...
        let gradingType = ["AI", "A", "Other Graded"][index];
        ...
        const filteredStudents = maincoursestudents
            ...
            .filter(student => {
                ...
                return student.grading !== "AI" && student.grading !== "A";
            });
    ...
    const doughnutChartData = {
        labels: [`AI (${getPercentage(mergedData.axIStudentsCount)})`, `A (${getPercentage(mergedData.axStudentsCount)})`, `Other Graded (${getPercentage(mergedData.otherStudentsCount)})`],
        datasets: [
            {
