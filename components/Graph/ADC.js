            ...
            {selectedCourse ? (
                Data.length > 0 ? (
                    <div className="grid md:grid-cols-2 gap-6">
                        {/* Bar Chart */}
                        <div className="bg-white shadow-lg rounded-2xl p-6 transition-all transform">
                        ...
                        {/* Doughnut Chart */}
                        <div className="bg-white shadow-lg rounded-2xl p-6 flex flex-col items-center  transition-all transform ">
