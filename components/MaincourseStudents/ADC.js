...
const ADC = ({filteredStudents,handleDeleteStudent,maincoursestudents,filteredInstructors}) => {
...
<td className="px-4 py-1 text-center text-sm text-gray-500 border-r border-gray-300">
  ...
  <div className="bg-white p-6 rounded-lg shadow-lg w-full h-full overflow-y-auto">
            ...
            <h2 className="font-bold text-white bg-red-800 p-4 font-mono underline text-center text-4xl mb-2">RESULT SHEET OF {modalData.Course} COURSE {modalData.mainCourse}  AT IMA DEHRADUN {modalData.targetYear} </h2>
  ...
  <div className="mt-4 p-4 bg-gray-200 rounded-lg">
        ...
        <table className="w-full border border-gray-300">
          ...
          <tbody className="divide-y divide-gray-800">
            ...
            <tr>
              <td className="px-4 py-2 text-center border-r border-gray-800">CZ</td>
