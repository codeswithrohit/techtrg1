...
const handlePrint = () => {
  ...
  return (
    ...
    <div id='print-section'>
      ...
      <thead className="bg-gray-50">
          <tr>
            ...
            <th colSpan="1" className="px-4 py-1 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-300">
              39 GTC % 
            </th>
    ...
    const pre1stAI = student.students.filter(s => s.phase === 'pre1st' && s.grading === 'PASS').length;
    const pre2ndAI = student.students.filter(s => s.phase === 'pre2nd' && s.grading === 'PASS').length;
    ...
    const combinedTotal = totalAI ;
            const combinedPercentage = totalstudents > 0 ? ((totalAI  ) / totalstudents) * 100 : 0;
...
<option value="">Select Grade</option>
  ...
  <div className="mt-4 p-4 bg-gray-200 rounded-lg">
        ...
        <table className="w-full border border-gray-300">
          ...
          <tbody className="divide-y divide-gray-800">
            <tr>
              <td className="px-4 py-2 text-center border-r border-gray-800">PASS</td>
              <td className="px-4 py-2 text-center">{gradingSummary.PASS}</td>
            </tr>
            <tr>
              <td className="px-4 py-2 text-center border-r border-gray-800">FAIL</td>
              <td className="px-4 py-2 text-center">{gradingSummary.FAIL}</td>
            </tr>
