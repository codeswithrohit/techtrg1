...
const CLC = ({ students,selectedCourses,selectedMaintitles,selectedYears }) => {
    const [filteredStudentsdata, setFilteredStudentsdata] = useState([]);
    useEffect(() => {
        const secCdrStudents = students.filter(student => student.course === "CLC");
...
//   console.log('Grouped Data:', groupedData);
  ...
  <h1 className='font-bold text-white bg-red-800 p-4 font-mono underline text-center text-4xl' >CLC COURSE UNIT & YR WISE COURSE GRADING</h1>
