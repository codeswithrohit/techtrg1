...
const SECCDR = ({ students,selectedCourses,selectedMaintitles,selectedYears }) => {
    const [filteredStudentsdata, setFilteredStudentsdata] = useState([]);
    useEffect(() => {
        // Filter students for course "SEC CDR"
        const secCdrStudents = students.filter(student => student.course === "SEC CDR");
...
//   console.log('Grouped Data:', groupedData);
  ...
  <h1 className='font-bold text-white bg-red-800 p-4 font-mono underline text-center text-4xl' >SEC CDR COURSE UNIT & YR WISE COURSE GRADING</h1>
